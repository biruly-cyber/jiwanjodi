        ...
        <div className="py-3">
          <ul className="flex gap-12 cursor-pointer relative">
            ...
            <li
              ...
              className=" px-4 rounded-full border bg-transparent text-white hover:text-white hover:bg-blue-700 hover:border-none flex items-center"
            >
              Are you a vendor?
            </li>
            <li>
              <Button className="px-4  rounded-full bg-blue-600 hover:bg-blue-700">
                Sign in
              </Button>
            </li>
          </ul>
